...
export function selector<E, I extends StrOrNum>(
  items: Items<E, I>,
  selector: Selector<E, I>,
  operation: Operation<E, I>
) {
  if (typeof selector === 'function') {
    ...
    Array.from(selector as Iterable<I>).forEach(id => operation(items.select(id), id))
  }
}
